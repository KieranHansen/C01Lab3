...
function Dialog({open, initialNote, closeDialog, postNote: postNoteState}) {
    ...
    //I wasn't able to figure out why the entry param of this function was misbehaving
    //It doesn't seem to give the intended values of the note in the database.
